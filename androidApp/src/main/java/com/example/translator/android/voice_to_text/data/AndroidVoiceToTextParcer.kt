package com.example.translator.android.voice_to_text.data
...
import com.example.translator.core.domain.util.CommonMutableStateFlow
...
import com.example.translator.voice_to_text.domain.VoiceToTextParserState
...
class AndroidVoiceToTextParser(
    ...
    override fun startListening(languageCode: String) {
        ...
        if (!SpeechRecognizer.isRecognitionAvailable(app)) {
            _state.update {
                it.copy(error = app.getString(R.string.recognition_is_not_available))
            }
            return
        }
    ...
    override fun onRmsChanged(rmsDb: Float) {
        _state.update {
            it.copy(powerRatio = rmsDb * (1f / (12f - (-2f)))) //normalize to 0..1
        }
    }
